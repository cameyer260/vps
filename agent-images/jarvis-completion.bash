...
_jarvis() {
  ...
  if (( COMP_CWORD == 1 )); then
    ...
    # literal subcommands rpc/models/projects/build/help. Resolve the projects dir the
    ...
    COMPREPLY=( $(compgen -W "$(ls "$projects_dir" 2>/dev/null) rpc models build help projects" -- "$cur") )
